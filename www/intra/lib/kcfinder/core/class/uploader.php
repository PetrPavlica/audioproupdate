...
class uploader {
    ...
    public function __construct() {
        ...
        /* //Nastavení vlastní cesty by url pro nahrávání souborů  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! pozor ZDE JE ZMĚNA !!!!!!!!!!
          if(isset($_GET['ownurldir']))
          {
          $this->config['uploadURL'] = $_GET['ownurldir'];
          $_SESSION['name_directory'] = $_GET['ownurldir'];
          }
          //nastavení k povolení práv k zápisu a tvorbě složek
          if(isset($_GET['allowDirPermision']))
          {
          $this->config['access']['dirs']['create'] = $_GET['allowDirPermision'];
          $this->config['access']['dirs']['delete'] = $_GET['allowDirPermision'];
          $this->config['access']['dirs']['rename'] = $_GET['allowDirPermision'];
          $_SESSION['allowDirPermision'] = $_GET['allowDirPermision'];
          }
         */
